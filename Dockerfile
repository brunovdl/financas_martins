# ============================================================
# MAI Finance Flet Web App — Dockerfile (Easypanel / Produção)
...
# 1. Dependências de sistema e libcap para vincular portas baixas (< 1024 como a porta 80)
...
# 4. Cria usuário e grupo não-root por segurança
